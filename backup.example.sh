...
/usr/bin/docker-compose -f /home/ubuntu/origami-backend/docker-compose.yml exec -T mongo mongodump --username admin --password password --archive --gzip --db origami >$BACKUP_FILENAME
